...
async def modguide(ctx):
    await ctx.send("https://media.discordapp.net/attachments/833954424425545788/897172202942767194/unknown.png?width=382&height=300\n" +
                   ...
                   "**this is outdated lowkey and will be updated soon**")
...
@client.hybrid_command(aliases=['slomo'])
@app_commands.allowed_installs(guilds=True, users=True)
@app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
...
@client.hybrid_command(aliases=['penwish','pw'])
@app_commands.allowed_installs(guilds=True, users=True)
@app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
async def usa(ctx):
...
@client.hybrid_command(aliases=['notationbook', 'psbook', 'book'])
@app_commands.allowed_installs(guilds=True, users=True)
@app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
...
@client.hybrid_command(aliases=['modtuts'])
@app_commands.allowed_installs(guilds=True, users=True)
@app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
async def pmpm(ctx):
...
@client.hybrid_command(aliases=['beginnermod'])
@app_commands.allowed_installs(guilds=True, users=True)
@app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
...
@client.hybrid_command(aliases=['i.sukpapermod', 'isukpapermod'])
@app_commands.allowed_installs(guilds=True, users=True)
@app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
...
@client.hybrid_command(aliases=['flying_panda'])
@app_commands.allowed_installs(guilds=True, users=True)
@app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
...
@client.hybrid_command(aliases=['canadashops'])
@app_commands.allowed_installs(guilds=True, users=True)
@app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
...
@client.hybrid_command(aliases=['index'])
@app_commands.allowed_installs(guilds=True, users=True)
@app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
...
client.hybrid_command(aliases=["garybotfaq"])
@app_commands.allowed_installs(guilds=True, users=True)
@app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
...
@client.hybrid_command(aliases=['ivanmod', 'ivan', 'ivanmodtut',])
@app_commands.allowed_installs(guilds=True, users=True)
@app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
...
@client.hybrid_command(aliases=['hashcomssa',])
@app_commands.allowed_installs(guilds=True, users=True)
@app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
...
@client.hybrid_command(aliases=['ta', 'thumbaround',])
@app_commands.allowed_installs(guilds=True, users=True)
@app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
async def tatut(ctx):
...
@client.hybrid_command(aliases=['tarev', 'thumbaroundreverse', 'thumbaroundrev',])
@app_commands.allowed_installs(guilds=True, users=True)
@app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
...
@client.hybrid_command(aliases=['powerlearningorder', 'powerorder',])
@app_commands.allowed_installs(guilds=True, users=True)
@app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
...
@client.hybrid_command(aliases=['backaround', 'koreanbak', 'koreanback', 'back,', 'weissanback', 'weissback' 'koreanbak',])
@app_commands.allowed_installs(guilds=True, users=True)
@app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
async def bak(ctx):
...
@client.hybrid_command(aliases=['bestmod'])
@app_commands.allowed_installs(guilds=True, users=True)
@app_commands.allowed_contexts(guilds=True, dms=True, private_channels=True)
